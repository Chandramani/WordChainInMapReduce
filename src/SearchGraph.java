...
public class SearchGraph extends Configured implements Tool
{
  ...
  public int run(String[] args) throws Exception {
    ...
    {      
      ...
      JobConf conf = new JobConf(getConf(), SearchGraph.class);
      conf.setJobName("SearchGraph");
      ...
      org.apache.hadoop.mapreduce.Counter counter = job.getCounters().findCounter(SearchGraph.Counters.MORE_GRAY);
